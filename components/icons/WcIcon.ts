...
import { assertNever } from "../../shared/tools.js";
...
export function renderIcon(icon: iconName, className: string): TemplateResult {
  return html`${unsafeHTML(getIcon(icon).replace('<svg ', ' <svg class="' + className + '"'))}`;
}

function getIcon(icon: iconName): string {
  switch (icon) {
    case "docRef":
    ...
    //eturn svg` <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 648.21 437.68"><path d="M647.7,145.6c0.1-0.71,0.2-1.42,0.31-2.14c0.1-0.81,0.1-1.53,0.2-2.34c0-0.71,0-1.42-0.1-2.03c-0.1-0.71-0.1-1.53-0.31-2.24	c-0.1-0.71-0.31-1.42-0.51-2.14c-0.2-0.71-0.41-1.42-0.71-2.14c-0.31-0.71-0.61-1.32-0.92-2.03c-0.31-0.71-0.71-1.32-1.12-2.03	c-0.41-0.61-0.81-1.12-1.22-1.73c-0.51-0.71-1.02-1.32-1.63-1.93c-0.2-0.2-0.41-0.51-0.61-0.71	C619.42,103.68,502.32,1.54,324.28,0.01C164.25-1.01,56.81,77.33,7.16,124.33l0.1,0.1c-6.92,6.51-9.36,16.89-5.29,26.04	l123.31,273.67c3.87,8.44,12.21,13.53,20.86,13.53c2.44,0,4.99-0.51,7.43-1.32c0.61-0.2,1.32-0.41,1.93-0.61h0.1c0,0,0,0,0.1,0	c2.44-0.92,4.68-2.14,6.82-3.97c24.32-20.86,76.61-55.55,154.95-55.55c0.71,0,1.32,0,2.03,0c88.92,0.71,146.71,46.39,157.39,55.55	c4.27,3.66,9.67,5.49,14.85,5.49c6.41,0,12.82-2.75,17.4-8.04c0.1-0.1,0.2-0.31,0.31-0.51c1.73-1.73,3.26-3.66,4.37-6l132.26-271.54	c0.2-0.31,0.2-0.71,0.41-1.02c0.31-0.71,0.61-1.53,0.81-2.24C647.4,147.02,647.6,146.31,647.7,145.6z M553.7,235.94	c-26.15-16.07-100.21-55.55-207.04-61.96l-0.31-127.07c127.38,7.83,216.5,70.91,250.88,99.6L553.7,235.94z M483.6,379.8	c-26.86-17.6-74.17-41.92-136.74-48.12l-0.2-111.81c101.94,6.61,169.19,45.88,186.79,57.38L483.6,379.8z M155.39,379.39	L108.9,276.23c32.96-21.36,97.57-53.51,191.98-56.87l0.2,111.3C235.77,334.01,186.83,357.92,155.39,379.39z M300.78,173.47	c-100.72,3.36-171.94,36.32-210.9,60.53l-39.27-87.29C96.39,106.83,180.63,52,300.57,46.5L300.78,173.47z"/></svg>`;
    // return `<svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">  	<path   d="M63.88,26.71c0.01-0.07,0.02-0.14,0.03-0.21c0.01-0.08,0.01-0.15,0.02-0.23c0-0.07,0-0.14-0.01-0.2  		c-0.01-0.07-0.01-0.15-0.03-0.22c-0.01-0.07-0.03-0.14-0.05-0.21c-0.02-0.07-0.04-0.14-0.07-0.21c-0.03-0.07-0.06-0.13-0.09-0.2  		c-0.03-0.07-0.07-0.13-0.11-0.2c-0.04-0.06-0.08-0.11-0.12-0.17c-0.05-0.07-0.1-0.13-0.16-0.19c-0.02-0.02-0.04-0.05-0.06-0.07  		c-2.13-2.01-13.64-12.05-31.14-12.2C16.36,12.3,5.8,20,0.92,24.62l0.01,0.01c-0.68,0.64-0.92,1.66-0.52,2.56l12.12,26.9  		c0.38,0.83,1.2,1.33,2.05,1.33c0.24,0,0.49-0.05,0.73-0.13c0.06-0.02,0.13-0.04,0.19-0.06c0,0,0.01,0,0.01,0c0,0,0,0,0.01,0  		c0.24-0.09,0.46-0.21,0.67-0.39c2.39-2.05,7.53-5.46,15.23-5.46c0.07,0,0.13,0,0.2,0c8.74,0.07,14.42,4.56,15.47,5.46  		c0.42,0.36,0.95,0.54,1.46,0.54c0.63,0,1.26-0.27,1.71-0.79c0.01-0.01,0.02-0.03,0.03-0.05c0.17-0.17,0.32-0.36,0.43-0.59l13-26.69  		c0.02-0.03,0.02-0.07,0.04-0.1c0.03-0.07,0.06-0.15,0.08-0.22C63.85,26.85,63.87,26.78,63.88,26.71z M54.64,35.59  		c-2.57-1.58-9.85-5.46-20.35-6.09l-0.03-12.49c12.52,0.77,21.28,6.97,24.66,9.79L54.64,35.59z M47.75,49.73  		c-2.64-1.73-7.29-4.12-13.44-4.73l-0.02-10.99c10.02,0.65,16.63,4.51,18.36,5.64L47.75,49.73z M15.49,49.69l-4.57-10.14  		c3.24-2.1,9.59-5.26,18.87-5.59l0.02,10.94C23.39,45.23,18.58,47.58,15.49,49.69z M29.78,29.45c-9.9,0.33-16.9,3.57-20.73,5.95  		l-3.86-8.58c4.5-3.92,12.78-9.31,24.57-9.85L29.78,29.45z"/>    </svg>  `;
    //   return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 433.5 255.4" style="enable-background:new 0 0 433.5 255.4;" xml:space="preserve"><path d="M421.8,45.5c-130-60.7-280.2-60.7-410.2,0C3.3,49.4-1.6,56.1,0.5,60.2L97.7,251c2.1,4,7.2,5.5,11.6,3.5c68.1-31.8,146.9-31.8,215,0c4.3,2,9.5,0.5,11.5-3.5L433,60.2C435.1,56.1,430.1,49.4,421.8,45.5z M33.2,54c53.2-22.7,110.1-35.3,167.9-37.2c1,30.2,2,60.4,3,90.6c-46.6,1.6-92.5,11.7-135.4,30L33.2,54z M110.7,235.8l-35.6-83.3c41-17.5,85-27.2,129.6-28.7c1,30.2,2,60.4,3,90.5C174.3,215.4,141.5,222.7,110.7,235.8z M322.8,235.8c-30.7-13.1-63.6-20.4-97-21.5c1-30.2,2-60.4,3-90.5c44.6,1.5,88.5,11.2,129.5,28.7L322.8,235.8z M364.8,137.3c-42.9-18.3-88.8-28.5-135.4-30c1-30.2,2-60.4,3-90.6c57.8,1.9,114.7,14.5,167.9,37.2L364.8,137.3z"/></svg>`;
    case "warp-flag":
...
export class WcIcon extends LitElement {
  ...
  @property() primaryColor: colorName = "text";
  @property() icon: iconName = "pen"; //Added string because lit-plugin throws non justifiable error.
...
`;
  ...
  render(): TemplateResult {
    ...
    return html`${unsafeHTML(getIcon(<iconName>this.icon).replace('<svg ', ' <svg class="' + cl + '"'))}`;
  }
