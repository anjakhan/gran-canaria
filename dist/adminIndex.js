...
`;var __decorate$3=function(e,t,o,r){var a,s=arguments.length,i=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,o,r);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let WcTraveldetailsPage=class extends h{static get styles(){return[traveldetailsStyles]}render(){return T`
    ...
    `}};WcTraveldetailsPage=__decorate$3([n$1("wc-traveldetails-page")],WcTraveldetailsPage);const L=window.L,createMap=(e,t)=>{const o=config.isMobile?9:10,r=L.map(e).setView([28.378412972969333,-14.115175194361],o),a=(new Date).getDate(),s=(new Date).getMonth()+1;L.tileLayer("http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:'&copy;<a href="http://www.esri.com/">Esri</a>i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community',maxZoom:18}).addTo(r),t&&t.map((e=>{const t=L.marker([parseFloat(e.location[0]),parseFloat(e.location[1])]).addTo(r).bindPopup(`<b>${e.popup}</b><br>${e.date}`);new Date(e.date).getDate()===a-1&&new Date(e.date).getMonth()+1===s&&t.openPopup()})),L.marker([28.173903183892257,-14.224354511395132]).addTo(r).bindPopup("<b>Casa Luciano</b>"),L.marker([28.421440804718152,-13.853181596486714]).addTo(r).bindPopup("<b>Camino Costa Ballena</b><br>2021-06-08"),L.marker([28.05377973446309,-14.323536843021353]).addTo(r).bindPopup("<b>Ventura Shopping Center</b><br>2021-06-09"),L.marker([28.384905315405938,-13.863943972471807]).addTo(r).bindPopup("<b>La Guirra Beach</b><br>2021-06-11"),L.marker([28.392091960114943,-13.853954683945577]).addTo(r).bindPopup("<b>Punta del Bajo</b><br>2021-06-11"),L.marker([28.403508295007967,-14.15554652495963]).addTo(r).bindPopup("<b>Cuevas de Ajuy</b><br>2021-06-12"),L.marker([28.388711737434996,-14.10026879269423]).addTo(r).bindPopup("<b>Barranco de las Peñitas</b><br>2021-06-12"),L.marker([28.49820981705814,-13.857695606907182]).addTo(r).bindPopup("<b>Puerto del Rosario</b><br>2021-06-13"),L.marker([28.211533376782686,-14.021162616671948]).addTo(r).bindPopup("<b>Gran Tarajal</b><br>2021-06-15")},mapStyles=r$1`
  /* .leaflet-map-pane {
    position: absolute;
    top: 0;
    left: 0;
