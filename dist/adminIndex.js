...
`;var __decorate$7=function(e,t,a,n){var r,i=arguments.length,s=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(i<3?r(s):i>3?r(t,a,s):r(t,a))||s);return i>3&&s&&Object.defineProperty(t,a,s),s};const canariaMenu=[{title:"Gran-Canaria",icon:"umbrella-beach"},{title:"Städte",icon:"house-tree"},{title:"Berge",icon:"volcano"},{title:"Höhlen",icon:"dungeon"},{title:"Wasser",icon:"water"},{title:"Parks",icon:"trees"},{title:"Erlebnisse",icon:"person-biking-mountain"}];let WcAppDrawer=class extends h{constructor(e){super(),this.selectedDrawer="Gran-Canaria",this.drawerOpen=!1,this.selectedDrawer=e}static get styles(){return[drawerStyles]}connectedCallback(){super.connectedCallback()}getDrawerSelection(e){this.callback=e}openDrawer(){this.drawerOpen=!this.drawerOpen,this.requestUpdate()}setDrawerSelection(e){this.selectedDrawer=e,this.callback&&this.callback(this.selectedDrawer)}render(){return T`
    ...
    `}};__decorate$7([e({type:String})],WcAppDrawer.prototype,"selectedDrawer",void 0),WcAppDrawer=__decorate$7([n$1("wc-app-drawer")],WcAppDrawer);const L=window.L;let map,markers=[];const createToDoMap=(e,t,a,n,r=9)=>{n=n||[27.960669242389123,-15.58718600810936];const i=L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/streets-v10/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw",{id:"mapbox.streets",attribution:"Map data © OpenStreetMap contributors, CC-BY-SA, Imagery © CloudMade"}),s=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{id:"mapbox.hiking",attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}),o=L.tileLayer("https://{s}.tile-cyclosm.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png",{id:"mapbox.hiking",attribution:'<a href="https://github.com/cyclosm/cyclosm-cartocss-style/releases" title="CyclOSM - Open Bicycle render">CyclOSM</a> | Map data: &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}),l=L.tileLayer("http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{id:"mapbox.hiking",attribution:'&copy;<a href="http://www.esri.com/">Esri</a>i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community'});map=L.map(e).setView(n,r);const c={Streets:i,Roadmap:s,Satellite:l,Hiking:o};"hikingmap"===t?o.addTo(map):"roadmap"===t?s.addTo(map):"streets"===t?i.addTo(map):l.addTo(map),L.control.layers(c).addTo(map),a?.map((e=>{const t=L.marker(e.location);markers.push(t),t.addTo(map).bindPopup(`<b>${e.name}</b><br>${e.location}`)}))},updateMap=e=>{map&&(markers?.forEach((e=>map.removeLayer(e))),markers=[],e?.map((e=>{const t=L.marker(e.location);markers.push(t),t.addTo(map).bindPopup(`<b>${e.name}</b><br>${e.location}`)})))};var __decorate$6=function(e,t,a,n){var r,i=arguments.length,s=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(i<3?r(s):i>3?r(t,a,s):r(t,a))||s);return i>3&&s&&Object.defineProperty(t,a,s),s};let WcSightseeingCard=class extends h{constructor(e){super(),this.sightseeing=e}static get styles(){return[r$1`
      .card-container {
        display: flex;
        justify-content: center;
        align-items: center;
...
`;var __decorate$3=function(e,t,a,n){var r,i=arguments.length,s=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(i<3?r(s):i>3?r(t,a,s):r(t,a))||s);return i>3&&s&&Object.defineProperty(t,a,s),s};let WcImageCard=class extends h{constructor(e,t){super(),this.imageUrl=e,this.sightseeing=t}static get styles(){return[r$1`
      .card-container {
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.sightseeing&&this.getPics(this.sightseeing.foldername),this.renderMap()}getPics(e){let t=[];fetch(`https://api.github.com/repos/anjakhan/gran-canaria/contents/assets/sightseeings/${e}?ref=main`).then((e=>e.json())).then((e=>{e.forEach((e=>t.push(e.download_url)))})).catch((e=>console.error(e))),setTimeout((()=>this.images=t),1e3)}getDetailsPage(e){this.callback=e}goBackToSightseeings(){location.hash="#"+this.sightseeing.topic,this.callback&&this.callback(!0)}renderMap(){const e=document.createElement("div");e.setAttribute("id","mapid"),e.style.height="100%",e.style.width="100%",this.mapContainer?.appendChild(e),createToDoMap(e,"hikingmap",[this.sightseeing],this.sightseeing?.location,15);const t=e.querySelector("a.leaflet-control-layers-toggle");if(t){t.style.width="30px",t.style.height="30px",t.style.padding="5px 7px";const e=new WcIcon;e.primaryColor="black",e.icon="layer-group",t.appendChild(e)}}renderImageCard(e){return new WcImageCard(e,this.sightseeing.foldername)}render(){const e=this.sightseeing;return T`
      <div class="details-page">
        ...
        <div class="details-container">
          ...
          <br>
          ${0===e.tags.length?"":T`
            <span>In der Nähe:</span> ${e.tags.join(", ")}
          `}
          <br><br>
...
`,wcAppLayout=new WcAppLayout;let appUser="user";function setDisplay(e,t){const a=document.getElementById(e);a&&(a.style.display=t)}document.getElementById("createAccountCtrl")?.addEventListener("click",(async()=>{const e=document.getElementById("emailCtrl")?.value,t=document.getElementById("passwordCtrl")?.value;await signinUser(e,t)})),document.getElementById("google-signin")?.addEventListener("click",(async()=>{await signinWithGoogle()})),firebase.auth().onAuthStateChanged((async function(e){if(e){appUser="trulli90@gmail.com"===e.email?"admin":"user",setDisplay("userAccount",""),setDisplay("loginPage","none");document.getElementById("userAccount")?.append(wcAppLayout);const t=document.getElementsByTagName("head")[0],a=document.createElement("style");a.setAttribute("type","text/css"),a.appendChild(document.createTextNode(masterStyles.toString())),t.appendChild(a)}else setDisplay("loginPage","")}));const logoutFunc=()=>{(async()=>{await firebase.auth().signOut(),window.location.reload()})()};document.getElementById("eye")?.addEventListener("click",(()=>{const e=document.getElementById("eye"),t=document.getElementById("passwordCtrl");"password"===t.type?(e.classList.remove("fa-eye-slash"),e.classList.add("fa-eye"),t.type="text"):(e.classList.remove("fa-eye"),e.classList.add("fa-eye-slash"),t.type="password")}));export{appUser,logoutFunc};