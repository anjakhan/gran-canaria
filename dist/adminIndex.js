...
`}render(){let t="color-"+this.primaryColor;return this.classList.contains("strict-no-zoom")&&(t+=" strict-no-zoom"),T`${o(getIcon(this.icon).replace("<svg ",' <svg class="'+t+'"'))}`}};__decorate$c([e()],WcIcon.prototype,"primaryColor",void 0),__decorate$c([e()],WcIcon.prototype,"icon",void 0),WcIcon=__decorate$c([n$1("wc-icon")],WcIcon);const menuItemH=28,submMenuHGap=7,contextOverlayDiv=createOverlayDiv();contextOverlayDiv.addEventListener("mousedown",removeCtxMenu);const contextMenuDiv=document.createElement("div");contextMenuDiv.classList.add("printess-ctx-menu"),contextMenuDiv.id="contextMenu";let canReceiveMenuClick=!1;function getLi(t){const e=document.createElement("li");if("-"===t.caption)return e.classList.add("printess-ctx-menu-item-seperator"),e;if(e.classList.add("printess-ctx-menu-item"),t.callback&&!0!==t.disabled&&e.addEventListener("mouseup",(()=>{canReceiveMenuClick&&t.callback&&t.callback()})),t.disabled)if(e.classList.add("disabled"),t.icon){const r=new WcIcon;r.icon=t.icon,r.primaryColor="gray",e.appendChild(r)}else e.appendChild(document.createElement("div"));else if(!t.textOnly)if(t.icon){const r=new WcIcon;r.icon=t.icon,t.icon.indexOf("-invers")>=0?r.primaryColor="headline":r.primaryColor="text",e.appendChild(r)}else{const r=document.createElement("div");t.color&&(r.style.backgroundColor=t.color,r.classList.add("color")),e.appendChild(r)}const r=document.createElement("div");if(r.classList.add("printess-ctx-menu-caption"),r.innerText=t.caption,t.font&&(r.style.fontFamily=t.font,r.style.fontSize="11pt"),e.appendChild(r),t.sub){const t=new WcIcon;t.icon="carret-right-solid",t.primaryColor="text",t.classList.add("arrow"),e.appendChild(t)}return e}function showCtxMenu(t,e,r=0,o=0,s=180,a=!1){t.preventDefault();const i=s;removeCtxMenu();const n=t.clientX,c=t.clientY;if(!t.target)return;if(!e){const r=t.target;"function"==typeof r.getContextMenu&&(e=r.getContextMenu(t.target,n,c))}if(!e)return;const l=28*e.filter((t=>"-"!==t.caption)).length+7*e.filter((t=>"-"===t.caption)).length;contextMenuDiv.style.height=l+"px",contextMenuDiv.style.width=i+"px",t.preventDefault();let h=n,p=c,d=n,v=c;contextMenuDiv.innerHTML="";const g=document.createElement("div");contextMenuDiv.appendChild(g);const w=document.createElement("ul");g.appendChild(w),canReceiveMenuClick=!1;for(const t of e){const e=getLi(t);if(e.addEventListener("mousedown",(()=>{canReceiveMenuClick=!0})),e.addEventListener("mouseup",(()=>{canReceiveMenuClick&&removeCtxMenu()})),t.sub&&t.sub.length){e.classList.add("printess-sub-menu-trigger");const r=document.createElement("div"),o=document.createElement("ul");r.appendChild(o),r.classList.add("printess-sub-menu");for(const e of t.sub){const t=getLi(e);o.appendChild(t)}v=window.innerHeight-c<7?-33-(c+7-window.innerHeight):7,d=window.innerWidth-n<2*i?-i:i,r.style.top=v+"px",r.style.left=d+"px",r.style.width=i+"px",e.onmouseover=()=>{r.style.display="block"},r.onmouseover=()=>{r.style.display="block"},e.onmouseout=()=>{r.style.display="none"},r.onmouseout=()=>{r.style.display="none"},e.appendChild(r)}w.appendChild(e)}p=c+l>window.innerHeight?window.innerHeight-l-10:c,window.innerWidth-(n+r)<i?(h=n-i,contextMenuDiv.classList.add("printess-rev-ctx-menu")):(contextMenuDiv.classList.remove("printess-rev-ctx-menu"),h=n),contextMenuDiv.style.top=p+o+"px",contextMenuDiv.style.left=h+r+"px",document.body.appendChild(contextOverlayDiv),document.body.appendChild(contextMenuDiv)}function removeCtxMenu(){contextMenuDiv.parentElement&&document.body.removeChild(contextMenuDiv),contextOverlayDiv.parentElement&&document.body.removeChild(contextOverlayDiv)}const config={mobileDeviceWidth:896,isMobile:isMobile(896)},layoutStyles=r$1`
  .account-layout {
...
`;var __decorate$b=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcAppDrawer=class extends h{constructor(t){super(),this.selectedDrawer="",this.drawerOpen=!1,this.drawers=[{name:"latest-story",title:"Fotos",icon:"camera-retro-duotone"},{name:"foto-preview",title:"Kalender",icon:"calendar-alt"},{name:"map",title:"Karte",icon:"map-duotone"},{name:"trip-details",title:"Reisedaten",icon:"plane-duotone"}],this.selectedDrawer=t}static get styles(){return[drawerStyles]}connectedCallback(){super.connectedCallback()}getDrawerSelection(t){this.callback=t}openDrawer(){this.drawerOpen=!this.drawerOpen,this.requestUpdate()}setDrawerSelection(t){this.selectedDrawer=t,this.callback&&this.callback(this.selectedDrawer)}render(){return T`
      ...
      <aside class="drawer ${!this.drawerOpen&&config.isMobile?"hidden":""}">
        ...
        ${this.drawers.map((t=>T`<div class="tab ${this.selectedDrawer===t.name?"selected":""}" style="display: flex; align-items: center;"
          @click=${()=>this.setDrawerSelection(t.name)}><wc-icon primaryColor=${this.selectedDrawer===t.name?"green":"toolbar"} icon=${t.icon}></wc-icon>${t.title}</div>`))}
      </aside>
    `}};__decorate$b([e({type:String})],WcAppDrawer.prototype,"selectedDrawer",void 0),WcAppDrawer=__decorate$b([n$1("wc-app-drawer")],WcAppDrawer);const uploadStyles=r$1`
  .upload-page {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;class NobsBase{constructor(t,e){if(t instanceof Nobs&&e instanceof NobsBase){t._called_from_constructor_findMutations(e);for(const r of Object.keys(e)){const o=e[r];o instanceof NobsBase?t.hasObjectReplacement(o)?this[r]=t.getObjectReplacement(o):t._called_from_constructor_hasMutation(o)?this[r]=new o.constructor(t,o):this[r]=o:o instanceof Map?this[r]=t._called_from_constructor_cloneMap(o):Array.isArray(o)?this[r]=t._called_from_constructor_cloneArray(o):t.hasProperty(e,r)?this[r]=t.popProperty(e,r):this[r]=e[r]}const r=t.getChangedProperties(e);if(r&&r.size>0)for(const[t,e]of r)this[t]=e}}}class Nobs{constructor(){this.createdObjects=new Map,this.replacedObjects=new Map,this.removedObjects=new Set,this.changedProperties=new Map,this.replacedCollections=new Map,this.mutatedObjects=new Set}setProperty(t,e,r){if(t&&(r instanceof NobsBase||null===r)&&t[e]instanceof NobsBase)this.replaceObject(t[e],r);else{let o=this.changedProperties.get(t);o||(o=new Map,this.changedProperties.set(t,o)),o.set(e,r)}return this}getChangedProperties(t){return this.changedProperties.get(t)}getProperty(t,e){const r=this.changedProperties.get(t);return r&&r.has(e)?r.get(e):t[e]}popProperty(t,e){const r=this.changedProperties.get(t);if(r&&r.has(e)){const t=r.get(e);return r.delete(e),t}return t[e]}hasProperty(t,e){const r=this.changedProperties.get(t);return!(!r||!r.has(e))}replaceCollection(t,e){return this.replacedCollections.set(t,e),this}addToCollection(t,e,r,o){let s=this.createdObjects.get(t);s||(s=[],this.createdObjects.set(t,s));const a={object:e,insertBefore:r,insertAfter:o};return s.push(a),this}reOrderInsideCollection(t,e,r,o){return e!==r&&e!==o&&(this.removeObject(e),this.addToCollection(t,e,r,o)),this}replaceObject(t,e){return this.replacedObjects.set(t,e),this}hasObjectReplacement(t){return this.replacedObjects.has(t)}getObjectReplacement(t){return this.replacedObjects.get(t)}removeObject(t){return this.removedObjects.add(t),this}_called_from_constructor_hasMutation(t){return this.mutatedObjects.has(t)}_called_from_constructor_findMutations(t){let e=!1;for(const r of Object.keys(t)){const o=t[r];if(this.hasProperty(t,r)&&(e=!0),o instanceof NobsBase)(this.replacedObjects.has(o)||this._called_from_constructor_findMutations(o))&&(this.mutatedObjects.add(o),e=!0);else if(o instanceof Map||Array.isArray(o)){if(this.replacedCollections.has(o)&&(this.mutatedObjects.add(o),e=!0),o instanceof Map)for(const t of o.values())(this.removedObjects.has(t)||this.replacedObjects.has(t))&&(this.mutatedObjects.add(t),e=!0),e=this._called_from_constructor_findMutations(t)||e;else for(const t of o)(this.removedObjects.has(t)||this.replacedObjects.has(t))&&(this.mutatedObjects.add(t),e=!0),e=this._called_from_constructor_findMutations(t)||e;this.createdObjects.has(o)&&(e=!0)}}return e&&this.mutatedObjects.add(t),e}static getId(t){const e=t.id;if(!e)throw new Error("Nobs: By convention, objects stored in a Map need to have an 'id' property");return e}_called_from_constructor_cloneMap(t){const e=new Map,r=this.replacedCollections.get(t);if(r&&r instanceof Map)return r;let o;const s=this.createdObjects.get(t);for(const[r,a]of t.entries())if(!this.removedObjects.has(a)){if(o=this.replacedObjects.get(a),!o&&this.mutatedObjects.has(a)&&(o=new a.constructor(this,a)),o||(o=a),s)for(const t of s)t.insertBefore===o&&e.set(Nobs.getId(t.object),t.object);if(e.set(r,o),s)for(const t of s)t.insertAfter===o&&e.set(Nobs.getId(t.object),t.object)}if(s)for(const t of s)void 0===t.insertBefore&&void 0===t.insertAfter&&e.set(Nobs.getId(t.object),t.object);return e}_called_from_constructor_cloneArray(t){const e=[],r=this.replacedCollections.get(t);if(r&&Array.isArray(r))return r;let o;const s=this.createdObjects.get(t);for(const r of t)if(!this.removedObjects.has(r)){if(o=this.replacedObjects.get(r),!o&&this.mutatedObjects.has(r)&&(o=new r.constructor(this,r)),o||(o=r),s)for(const t of s)t.insertBefore===o&&e.push(t.object);if(e.push(o),s)for(const t of s)t.insertAfter===o&&e.push(t.object)}if(s)for(const t of s)void 0===t.insertBefore&&void 0===t.insertAfter&&e.push(t.object);return e}}class UploadNobs extends NobsBase{constructor(t,e){var r,o,s,a,i;if(super(t,e),!(t instanceof Nobs||e instanceof UploadNobs)){const e=t;this.id="",this.headline=null!==(r=e.headline)&&void 0!==r?r:"",this.story=null!==(o=e.story)&&void 0!==o?o:[],this.date=null!==(s=e.date)&&void 0!==s?s:new Date,this.location=null!==(a=e.location)&&void 0!==a?a:[],this.foldername=null!==(i=e.foldername)&&void 0!==i?i:""}}toDto(){return{id:"",headline:this.headline,story:this.story,date:this.date,location:this.location,foldername:this.foldername}}}const fotoUploadStyles=r$1`
...
`;var __decorate$a=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};const fileTypes=["image/jpg","image/bmp","image/jpeg","image/png","image/tiff","image/webp"],validFileType=t=>fileTypes.includes(t.type);let WcUploadFotos=class extends h{constructor(t,e){super(),this.foldername=t,this.date=e}static get styles(){return[fotoUploadStyles]}updateImageDisplay(t){console.log(t.target.files);const e=t.target.files;if(e){for(const t of e)if(validFileType(t)){const e=document.createElement("img"),r=this.date+"_"+this.foldername;e.src=URL.createObjectURL(t),e.alt=t.name,uploadImage(t,r)}alert("files uploaded")}}render(){return T`
      <div class="foto-upload-container">
        <div class="file-loader">
          <label htmlFor='myfile'>UPLOAD FOTOS</label>
          <input type='file' name='myfile' id='myfile' accept=".jpg, .jpeg, .png, .tiff, .bmp" className='file-input' @change=${t=>this.updateImageDisplay(t)} multiple />
        </div>
        <div className="preview">
        </div>        
      </div>
    `}};__decorate$a([e({type:String})],WcUploadFotos.prototype,"foldername",void 0),__decorate$a([e({type:String})],WcUploadFotos.prototype,"date",void 0),__decorate$a([o$1(".preview")],WcUploadFotos.prototype,"preview",void 0),__decorate$a([o$1(".file-input")],WcUploadFotos.prototype,"fileInput",void 0),WcUploadFotos=__decorate$a([n$1("wc-upload-fotos")],WcUploadFotos);const formStyles=r$1`
  form {
    font-family: Ubuntu, 'Open Sans', 'Helvetica Neue', sans-serif;
    display: flex;
    flex-direction: column;
...
`;var __decorate$9=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i},__awaiter$3=function(t,e,r,o){return new(r||(r=Promise))((function(s,a){function i(t){try{c(o.next(t))}catch(t){a(t)}}function n(t){try{c(o.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((o=o.apply(t,e||[])).next())}))};let WcUploadForm=class extends h{static get styles(){return[formStyles]}setState(t){this.state=new UploadNobs(t,this.state)}connectedCallback(){super.connectedCallback();const t=new Nobs;t.setProperty(this.state,"id",""),this.setState(t)}handleSubmit(t){return __awaiter$3(this,void 0,void 0,(function*(){t.preventDefault();try{yield createTravelDocument(this.state)}catch(t){console.log(t)}}))}handleChange(t){const e=new Nobs,r=t.target.name,o=t.target.value;e.setProperty(this.state,r,o),this.setState(e)}handleStory(t){const e=new Nobs,r=t.target.name,o=t.target.value.split("_b");e.setProperty(this.state,r,o),this.setState(e)}handleLocation(t){const e=new Nobs,r=t.target.name,o=t.target.value.split(",");e.setProperty(this.state,r,o),this.setState(e)}renderFileLoader(){const t=this.state?this.state.foldername:"",e=this.state?this.state.date:"";return new WcUploadFotos(t,e)}render(){return T`
    ...
    `}};__decorate$9([e({type:Object})],WcUploadForm.prototype,"state",void 0),WcUploadForm=__decorate$9([n$1("wc-upload-form")],WcUploadForm);var __decorate$8=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcUploadPage=class extends h{static get styles(){return[uploadStyles]}render(){return T`
      <div class="upload-page">
        <h1 class="title">Upload Foto Story</h1>
        <wc-upload-form></wc-upload-form>
      </div>
    `}};WcUploadPage=__decorate$8([n$1("wc-upload-page")],WcUploadPage);const dialogStyles=r$1`
  .modal {
...
`;var __decorate$7=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcBackdrop=class extends h{constructor(){super()}static get styles(){return r$1`
      :host, :host * {
          box-sizing: border-box;
      }
      :host  {
    ...
    `}};__decorate$6([e({attribute:!1,type:Number})],WcDialogImage.prototype,"idx",void 0),__decorate$6([e({attribute:!1,type:Array})],WcDialogImage.prototype,"images",void 0),WcDialogImage=__decorate$6([n$1("wc-dialog-image")],WcDialogImage);const fotostoryStyles=r$1`
  .fotostory-container {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var __decorate$5=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcFotostory=class extends h{constructor(t){super(),this.fotostory=t}static get styles(){return[fotostoryStyles]}connectedCallback(){super.connectedCallback(),this.fotostory&&this.getPics(this.fotostory.foldername)}getPics(t){let e=[];fetch(`https://api.github.com/repos/anjakhan/fuerteventura/contents/assets/${t}`).then((t=>t.json())).then((t=>{t.forEach((t=>e.push(t.download_url)))})).catch((t=>console.error(t))),setTimeout((()=>this.images=e),2e3)}renderImage(t){new WcDialogImage(t,this.images).showDialog()}render(){return T`
    ...
    `}};__decorate$5([e({type:Object})],WcFotostory.prototype,"fotostory",void 0),__decorate$5([e({type:Array})],WcFotostory.prototype,"images",void 0),WcFotostory=__decorate$5([n$1("wc-fotostory")],WcFotostory);const fotoPreviewStyles=r$1`
  .calendar-container {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var __decorate$4=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i},__awaiter$2=function(t,e,r,o){return new(r||(r=Promise))((function(s,a){function i(t){try{c(o.next(t))}catch(t){a(t)}}function n(t){try{c(o.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((o=o.apply(t,e||[])).next())}))};let WcFotoPreview=class extends h{constructor(){super(...arguments),this.date=new Date,this.month="Juni",this.showStory=!1}static get styles(){return[fotoPreviewStyles]}connectedCallback(){super.connectedCallback(),this.loadFotos()}loadFotos(){return __awaiter$2(this,void 0,void 0,(function*(){const t=[];try{yield getTravelDocs().then((e=>{e.forEach((e=>t.push(e)))})).catch((t=>console.log("no traveldocs found",t)))}catch(t){console.log(t)}this.fotos=t,console.log(this.fotos)}))}renderFotostory(){return new WcFotostory(this.fotostory)}renderFotos(t,e){const r=this.fotos.filter((r=>new Date(r.date).getDate()===t&&new Date(r.date).getMonth()+1===e));this.fotostory=r[0],this.showStory=!0}renderJuneCalendar(){const t=[];for(let e=1;e<=30;e++)t.push(e);return T`
      <div class="date-box disabled"></div>
      ${t.map(((t,e)=>T`
      <div class="date-box" @click=${()=>this.renderFotos(e+1,6)}>
        <span class="date-text ${this.date.getDate()===e+1&&5===this.date.getMonth()?"today":""}">${e+1}</span>
      </div>`))}
      <div class="date-box disabled"></div><div class="date-box disabled"></div>
      <div class="date-box disabled"></div><div class="date-box disabled"></div>
    `}renderJulyCalendar(){const t=[];for(let e=1;e<=31;e++)t.push(e);return T`
      <div class="date-box disabled"></div>
      <div class="date-box disabled"></div>
      <div class="date-box disabled"></div>
      ${t.map(((t,e)=>T`
      <div class="date-box" @click=${()=>this.renderFotos(e+1,7)}>
        <span class="date-text ${this.date.getDate()===e+1&&6===this.date.getMonth()?"today":""}">${e+1}</span>
      </div>`))}
      <div class="date-box disabled"></div>
    `}render(){return T`
    ...
    `}};__decorate$4([e({type:Array})],WcFotoPreview.prototype,"fotos",void 0),__decorate$4([e({type:Object})],WcFotoPreview.prototype,"fotostory",void 0),__decorate$4([e({type:Object})],WcFotoPreview.prototype,"date",void 0),__decorate$4([e({type:String})],WcFotoPreview.prototype,"month",void 0),__decorate$4([e({type:Boolean})],WcFotoPreview.prototype,"showStory",void 0),WcFotoPreview=__decorate$4([n$1("wc-foto-preview")],WcFotoPreview);const traveldetailsStyles=r$1`
...
`;var __decorate$3=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcTraveldetailsPage=class extends h{static get styles(){return[traveldetailsStyles]}render(){return T`
...
`;var __decorate$2=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcFuerteMapPage=class extends h{static get styles(){return[mapStyles]}renderMap(){var t;const e=document.createElement("div");e.setAttribute("id","mapid"),e.style.height="100%",e.style.width="130%",null===(t=this.shadowRoot)||void 0===t||t.append(e),createMap(e)}render(){return T`
        ${this.renderMap()}
    `}};__decorate$2([o$1("#mapid")],WcFuerteMapPage.prototype,"mapid",void 0),WcFuerteMapPage=__decorate$2([n$1("wc-fuerte-map-page")],WcFuerteMapPage);var __decorate$1=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i},__awaiter$1=function(t,e,r,o){return new(r||(r=Promise))((function(s,a){function i(t){try{c(o.next(t))}catch(t){a(t)}}function n(t){try{c(o.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((o=o.apply(t,e||[])).next())}))};let WcLatestStory=class extends h{constructor(){super(...arguments),this.date=(new Date).getDate(),this.month=(new Date).getMonth()+1}static get styles(){return[]}connectedCallback(){super.connectedCallback(),this.loadFotos()}loadFotos(){return __awaiter$1(this,void 0,void 0,(function*(){const t=[];try{yield getTravelDocs().then((e=>{e.forEach((e=>t.push(e)))})).catch((t=>console.log("no traveldocs found",t)))}catch(t){console.log(t)}this.fotos=t,this.getLatestFotos()}))}getLatestFotos(){const t=this.fotos.filter((t=>new Date(t.date).getDate()===this.date-1&&new Date(t.date).getMonth()+1===this.month));this.fotostory=t[0]}renderFotostory(){return new WcFotostory(this.fotostory)}render(){return T`
      <div>
        ${this.renderFotostory()}
      </div>
    `}};__decorate$1([e({type:Array})],WcLatestStory.prototype,"fotos",void 0),__decorate$1([e({type:Object})],WcLatestStory.prototype,"fotostory",void 0),WcLatestStory=__decorate$1([n$1("wc-latest-story")],WcLatestStory);var __decorate=function(t,e,r,o){var s,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(s=t[n])&&(i=(a<3?s(i):a>3?s(e,r,i):s(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcAppLayout=class extends h{constructor(){super(...arguments),this.selectedDrawer="latest-story"}static get styles(){return[layoutStyles,navbarStyles]}render(){return T`
        <div class="account-layout">
            <header>
                ...
                <div class="user-icon" style="position: fixed; right: 40px; top; 0px; z-index: 99;">
                    <wc-icon @mousedown=${t=>this.userClick(t)} primaryColor="island" icon="user-solid" style="width: 30px; height: 25px; cursor: pointer;"></wc-icon>
                </div>
            </header>
        ...
        `}renderDrawer(){const t=new WcAppDrawer(this.selectedDrawer);return t.getDrawerSelection((t=>{this.selectedDrawer=t})),t}getUserContent(){switch(this.selectedDrawer){case"latest-story":return new WcLatestStory;case"trip-details":return new WcTraveldetailsPage;case"foto-preview":return new WcFotoPreview;case"upload":return new WcUploadPage;case"map":return new WcFuerteMapPage}}userClick(t){showCtxMenu(t,[{caption:"Log out",callback:()=>{this.logoutUser()}}])}logoutUser(){logoutFunc()}};__decorate([e({type:String})],WcAppLayout.prototype,"selectedDrawer",void 0),WcAppLayout=__decorate([n$1("wc-app-layout")],WcAppLayout),r$1`
  :host, :host * {
    box-sizing: border-box; 
  }
  :host  {
...
`;var _a,_b,_c,__awaiter=function(t,e,r,o){return new(r||(r=Promise))((function(s,a){function i(t){try{c(o.next(t))}catch(t){a(t)}}function n(t){try{c(o.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((o=o.apply(t,e||[])).next())}))};const wcAppLayout=new WcAppLayout;let appUser="user";function setDisplay(t,e){const r=document.getElementById(t);r&&(r.style.display=e)}null===(_a=document.getElementById("createAccountCtrl"))||void 0===_a||_a.addEventListener("click",(()=>__awaiter(void 0,void 0,void 0,(function*(){var t,e;const r=null===(t=document.getElementById("emailCtrl"))||void 0===t?void 0:t.value,o=null===(e=document.getElementById("passwordCtrl"))||void 0===e?void 0:e.value;yield signinUser(r,o)})))),null===(_b=document.getElementById("google-signin"))||void 0===_b||_b.addEventListener("click",(()=>__awaiter(void 0,void 0,void 0,(function*(){yield signinWithGoogle()})))),firebase.auth().onAuthStateChanged((function(t){return __awaiter(this,void 0,void 0,(function*(){if(t){appUser="trulli90@gmail.com"===t.email?"admin":"user",setDisplay("userAccount",""),setDisplay("loginPage","none");const e=document.getElementById("userAccount");null==e||e.append(wcAppLayout);const r=document.getElementsByTagName("head")[0],o=document.createElement("style");o.setAttribute("type","text/css"),o.appendChild(document.createTextNode(masterStyles.toString())),r.appendChild(o)}else setDisplay("loginPage","")}))}));const logoutFunc=()=>{__awaiter(void 0,void 0,void 0,(function*(){yield firebase.auth().signOut(),window.location.reload()}))};null===(_c=document.getElementById("eye"))||void 0===_c||_c.addEventListener("click",(()=>{const t=document.getElementById("eye"),e=document.getElementById("passwordCtrl");"password"===e.type?(t.classList.remove("fa-eye-slash"),t.classList.add("fa-eye"),e.type="text"):(t.classList.remove("fa-eye"),t.classList.add("fa-eye-slash"),e.type="password")}));export{appUser,logoutFunc};