 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}const o$2=({finisher:e,descriptor:t})=>(o,r)=>{var a;if(void 0===r){const r=null!==(a=o.originalKey)&&void 0!==a?a:o.key,i=null!=t?{kind:"method",placement:"prototype",key:r,descriptor:t(o.key)}:{...o,key:r};return null!=e&&(i.finisher=function(t){e(t,r)}),i}{const a=o.constructor;void 0!==t&&Object.defineProperty(o,r,t(r)),null==e||e(a,r)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var __decorate$5=function(e,t,o,r){var a,i=arguments.length,n=i<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(n=(i<3?a(n):i>3?a(t,o,n):a(t,o))||n);return i>3&&n&&Object.defineProperty(t,o,n),n},__awaiter$3=function(e,t,o,r){return new(o||(o=Promise))((function(a,i){function n(e){try{l(r.next(e))}catch(e){i(e)}}function s(e){try{l(r.throw(e))}catch(e){i(e)}}function l(e){var t;e.done?a(e.value):(t=e.value,t instanceof o?t:new o((function(e){e(t)}))).then(n,s)}l((r=r.apply(e,t||[])).next())}))};let WcFotoPreview=class extends h{constructor(){super(...arguments),this.date=new Date,this.month="Juni",this.showStory=!1}static get styles(){return[fotoPreviewStyles]}connectedCallback(){super.connectedCallback(),this.loadFotos()}loadFotos(){return __awaiter$3(this,void 0,void 0,(function*(){const e=[];try{yield getTravelDocs().then((t=>{t.forEach((t=>e.push(t)))})).catch((e=>console.log("no traveldocs found",e)))}catch(e){console.log(e)}this.fotos=e,console.log(this.fotos)}))}renderFotostory(){return new WcFotostory(this.fotostory)}renderFotos(e,t){const o=this.fotos.filter((o=>new Date(o.date).getDate()===e&&new Date(o.date).getMonth()+1===t));this.fotostory=o[0],this.showStory=!0}renderJuneCalendar(){const e=[];for(let t=1;t<=30;t++)e.push(t);return T`
...
`;var __decorate$4=function(e,t,o,r){var a,i=arguments.length,n=i<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(n=(i<3?a(n):i>3?a(t,o,n):a(t,o))||n);return i>3&&n&&Object.defineProperty(t,o,n),n};let WcTraveldetailsPage=class extends h{static get styles(){return[traveldetailsStyles]}render(){return T`
    ...
    `}};WcTraveldetailsPage=__decorate$4([n$1("wc-traveldetails-page")],WcTraveldetailsPage);const L=window.L,createMap=(e,t)=>{const o=config.isMobile?9:10,r=L.map(e).setView([28.378412972969333,-14.115175194361],o),a=(new Date).getDate(),i=(new Date).getMonth()+1;L.tileLayer("http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:'&copy;<a href="http://www.esri.com/">Esri</a>i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community',maxZoom:18}).addTo(r),t&&t.map((e=>{const t=L.marker([parseFloat(e.location[0]),parseFloat(e.location[1])]).addTo(r).bindPopup(`<b>${e.popup}</b><br>${e.date}`);new Date(e.date).getDate()===a-1&&new Date(e.date).getMonth()+1===i&&t.openPopup()})),L.marker([28.421440804718152,-13.853181596486714]).addTo(r).bindPopup("<b>Camino Costa Ballena</b><br>2021-06-08"),L.marker([28.05377973446309,-14.323536843021353]).addTo(r).bindPopup("<b>Ventura Shopping Center</b><br>2021-06-09"),L.marker([28.384905315405938,-13.863943972471807]).addTo(r).bindPopup("<b>La Guirra Beach</b><br>2021-06-11"),L.marker([28.392091960114943,-13.853954683945577]).addTo(r).bindPopup("<b>Punta del Bajo</b><br>2021-06-11"),L.marker([28.403508295007967,-14.15554652495963]).addTo(r).bindPopup("<b>Cuevas de Ajuy</b><br>2021-06-12"),L.marker([28.388711737434996,-14.10026879269423]).addTo(r).bindPopup("<b>Barranco de las Peñitas</b><br>2021-06-12"),L.marker([28.211533376782686,-14.021162616671948]).addTo(r).bindPopup("<b>Gran Tarajal</b><br>2021-06-15"),L.marker([28.08815093604716,-14.491244940249455]).addTo(r).bindPopup("<b>Aeródromo Abandonado</b><br>2021-06-18"),L.marker([28.065974396783957,-14.507462812109857]).addTo(r).bindPopup("<b>Faro de Punta Jandía</b><br>2021-06-18"),L.marker([28.07315393494029,-14.50021239147925]).addTo(r).bindPopup("<b>El Puertito</b><br>2021-06-18"),L.marker([28.102345138975522,-14.37578766980999]).addTo(r).bindPopup("<b>Casa Winter</b><br>2021-06-18"),L.marker([28.11044360840116,-14.387941738698748]).addTo(r).bindPopup("<b>Playa de Cofete</b><br>2021-06-18")},sightseeings=[{name:"Playa de La Señora",location:[28.05506304878142,-14.385447896561574]},{name:"Puerto Morro Jable",location:[28.04925525097606,-14.358251774389876]},{name:"Playa & Faro de Morro Jable",location:[28.045649107870403,-14.33409757065514]},{name:"Playa de Sotavento de Jandía (Risco del Paso)",location:[28.111445623239355,-14.263561462164526]},{name:"El Cotillo Beach",location:[28.690498290344827,-14.012006573483601]},{name:"Faro del Taston",location:[28.715918564960514,-14.013894141895339]},{name:"Majanicho (Popcornstrand)",location:[28.743867423297875,-13.940907127283767]},{name:"Corralejo City, Promenade, Glockenturm, Strandfiguren, Centro Commercial Shopping Center",location:[28.728652508179927,-13.864722454465213]},{name:"La Lajita & Oasis Park",location:[28.18751635455114,-14.156881222877573]},{name:"Pozo Negro von Klippen aus",location:[28.32364665275606,-13.8956818333923]},{name:"Playa de Esquinzo (Süd) - Butihondom",location:[28.06896669729653,-14.305984029258461]},{name:"Sugarhouse Oceania Fuerteventura",location:[28.079850172259125,-14.295569603694068]},{name:"Playa de Garcey",location:[28.34465358106306,-14.178945913729404]},{name:"Playa de la Solapa",location:[28.364255577905794,-14.165528766748274]},{name:"Playa de Tebeto",location:[28.59043711382251,-14.034491306410063]},{name:"Playa de los Mozos",location:[28.494250744508356,-14.089520973244307]},{name:"Playa de los Molinos",location:[28.543041483673917,-14.06324981603934]},{name:"Playa de Jarubio",location:[28.571466079367408,-14.047987991584325]},{name:"Playa de Esquinzo",location:[28.635045753245446,-14.02650183365281]},{name:"La Pared Beach - Playa del Viejo Rey (andere Seite)",location:[28.214773147724674,-14.222053986142976]},{name:"Piedra Playa",location:[28.665503322445627,-14.012452738522926]},{name:"Playa de los Verilitos und Playa de Viejo (Corralejo)",location:[28.735037873613198,-13.86696250741795]},{name:"Faro de La Entallada",location:[28.230186008337327,-13.948505129072634]},{name:"Salt Museum Salinas del Carmen",location:[28.36751277996282,-13.870040205775991]},{name:"Museo del Queso Majorero & Windmill at Cactus Garden",location:[28.431295609244707,-14.012616205774854]},{name:"Centro de Interpretacion de los Molinos",location:[28.352985591513775,-14.03526101434743]},{name:"Molino de viento histórico",location:[28.42140752547901,-13.989244030916215]},{name:"Playa & Cueva de Playa en Tarajalejo & Tuineje mirador terraza",location:[28.19059836096522,-14.111664362247657]},{name:"Volcan Calderon Hondo",location:[28.703214296392897,-13.914806335677875]},{name:"Montaña de Tindaya",location:[28.583962147073578,-13.96742533840112]},{name:"Barranco Encantado",location:[28.62997718488728,-14.004527277154441]}],createToDoMap=e=>{const t=config.isMobile?9:10,o=L.map(e).setView([28.378412972969333,-14.115175194361],t);L.tileLayer("http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:'&copy;<a href="http://www.esri.com/">Esri</a>i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community',maxZoom:18}).addTo(o),sightseeings.map((e=>{L.marker(e.location).addTo(o).bindPopup(`<b>${e.name}</b><br>${e.location}`)}))},mapStyles$1=r$1`
  /* .leaflet-map-pane {
    position: absolute;
    top: 0;
    left: 0;
