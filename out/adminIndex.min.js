...
`;var __decorate$5=function(e,t,o,r){var a,i=arguments.length,n=i<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(n=(i<3?a(n):i>3?a(t,o,n):a(t,o))||n);return i>3&&n&&Object.defineProperty(t,o,n),n},__awaiter$3=function(e,t,o,r){return new(o||(o=Promise))((function(a,i){function n(e){try{l(r.next(e))}catch(e){i(e)}}function s(e){try{l(r.throw(e))}catch(e){i(e)}}function l(e){var t;e.done?a(e.value):(t=e.value,t instanceof o?t:new o((function(e){e(t)}))).then(n,s)}l((r=r.apply(e,t||[])).next())}))};let WcFotoPreview=class extends h{constructor(){super(...arguments),this.date=new Date,this.month="Juli",this.showStory=!1}static get styles(){return[fotoPreviewStyles]}connectedCallback(){super.connectedCallback(),this.loadFotos()}loadFotos(){return __awaiter$3(this,void 0,void 0,(function*(){const e=[];try{yield getTravelDocs().then((t=>{t.forEach((t=>e.push(t)))})).catch((e=>console.log("no traveldocs found",e)))}catch(e){console.log(e)}this.fotos=e,console.log(this.fotos)}))}renderFotostory(){return new WcFotostory(this.fotostory)}renderFotos(e,t){if("Juni"===this.month&&e<8)return;if("Juli"===this.month&&e>6)return;const o=this.fotos.filter((o=>new Date(o.date).getDate()===e&&new Date(o.date).getMonth()+1===t));this.fotostory=o[0],this.showStory=!0}renderJuneCalendar(){const e=[];for(let t=1;t<=30;t++)e.push(t);return T`
      <div class="date-box disabled"></div>
      ${e.map(((e,t)=>T`
      <div class="date-box" @click=${()=>this.renderFotos(t+1,6)} style="cursor: ${t<7?"default":"cursor"}">
    ...
    `}renderJulyCalendar(){const e=[];for(let t=1;t<=31;t++)e.push(t);return T`
      ...
      <div class="date-box disabled"></div>
      ${e.map(((e,t)=>T`
      <div class="date-box" @click=${()=>this.renderFotos(t+1,7)} style="cursor: ${t>5?"default":"cursor"}">
