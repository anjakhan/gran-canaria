var __awaiter$3=function(t,e,r,s){return new(r||(r=Promise))((function(o,a){function i(t){try{c(s.next(t))}catch(t){a(t)}}function n(t){try{c(s.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?o(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((s=s.apply(t,e||[])).next())}))};const firebase=window.firebase,config$1={apiKey:"AIzaSyBUbyQiqE7TSAS2J5iIVII1Z99tKdd0AuE",authDomain:"fuerteventura-d4e75.firebaseapp.com",projectId:"fuerteventura-d4e75",storageBucket:"fuerteventura-d4e75.appspot.com",messagingSenderId:"378393506142",appId:"1:378393506142:web:4d16e60264d0388a685fcf"};firebase.initializeApp(config$1);const checkErrorCode=t=>{const e=document.getElementById("errorContainer"),r=document.getElementById("errorWrapper");e&&(e.style.display=""),"auth/email-already-in-use"===t?r&&(r.innerHTML="This email address is already in use. <br>Did you mean to sign in?"):"auth/invalid-email"===t?r&&(r.textContent="Invalid e-mail address!"):"auth/weak-password"===t?r&&(r.textContent="Your password is weaaaak!"):"auth/wrong-password"===t||"auth/user-not-found"===t?r&&(r.innerHTML="Invalid e-mail address or password. <br>Please try again!"):"auth/too-many-requests"===t&&r&&(r.innerHTML="Access to this account has been temporarily <br>disabled due to many failed login attempts.")};function signinWithGoogle(){return __awaiter$3(this,void 0,void 0,(function*(){const t=new firebase.auth.GoogleAuthProvider;t.setCustomParameters({prompt:"select_account"});try{return yield firebase.auth().signInWithPopup(t)}catch(t){const e=t.code;throw checkErrorCode(e),t}}))}function signinUser(t,e){return __awaiter$3(this,void 0,void 0,(function*(){try{return yield firebase.auth().signInWithEmailAndPassword(t,e)}catch(t){const e=t.code;throw checkErrorCode(e),t}}))}const createTravelDocument=(t,e)=>{var r;firestore.collection("fuerte").add({id:"",headline:null!==(r=t.headline)&&void 0!==r?r:"",story:t.story||"",foldername:t.date+"_"+t.foldername,date:t.date,location:t.location,images:e}).then((t=>{console.log("Document written with ID: ",t.id),firestore.collection("fuerte").doc(`${t.id}`).set({id:t.id},{merge:!0})})).catch((t=>{console.error("Error adding document: ",t)}))},getTravelDocs=()=>firestore.collection("fuerte").get().then((t=>t.docs.map((t=>t.data())))),uploadImage=(t,e)=>{firebase.storage().ref(`${e}/${t.name}`).put(t)},firestore=firebase.firestore();
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var t$2,i$4,s$4,e$3;const o$6=globalThis.trustedTypes,l$2=o$6?o$6.createPolicy("lit-html",{createHTML:t=>t}):void 0,n$5=`lit$${(Math.random()+"").slice(9)}$`,h$2="?"+n$5,r$2=`<${h$2}>`,u=document,c=(t="")=>u.createComment(t),d=t=>null===t||"object"!=typeof t&&"function"!=typeof t,v=Array.isArray,a$2=t=>{var e;return v(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])},f=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_=/-->/g,m=/>/g,p=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,$=/'/g,g=/"/g,y=/^(?:script|style|textarea)$/i,b=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),T=b(1),w=Symbol.for("lit-noChange"),A=Symbol.for("lit-nothing"),P=new WeakMap,V=(t,e,r)=>{var s,o;const a=null!==(s=null==r?void 0:r.renderBefore)&&void 0!==s?s:e;let i=a._$litPart$;if(void 0===i){const t=null!==(o=null==r?void 0:r.renderBefore)&&void 0!==o?o:null;a._$litPart$=i=new C(e.insertBefore(c(),t),t,void 0,r)}return i.I(t),i},E=u.createTreeWalker(u,129,null,!1),M=(t,e)=>{const r=t.length-1,s=[];let o,a=2===e?"<svg>":"",i=f;for(let e=0;e<r;e++){const r=t[e];let n,c,l=-1,h=0;for(;h<r.length&&(i.lastIndex=h,c=i.exec(r),null!==c);)h=i.lastIndex,i===f?"!--"===c[1]?i=_:void 0!==c[1]?i=m:void 0!==c[2]?(y.test(c[2])&&(o=RegExp("</"+c[2],"g")),i=p):void 0!==c[3]&&(i=p):i===p?">"===c[0]?(i=null!=o?o:f,l=-1):void 0===c[1]?l=-2:(l=i.lastIndex-c[2].length,n=c[1],i=void 0===c[3]?p:'"'===c[3]?g:$):i===g||i===$?i=p:i===_||i===m?i=f:(i=p,o=void 0);const d=i===p&&t[e+1].startsWith("/>")?" ":"";a+=i===f?r+r$2:l>=0?(s.push(n),r.slice(0,l)+"$lit$"+r.slice(l)+n$5+d):r+n$5+(-2===l?(s.push(void 0),e):d)}const n=a+(t[r]||"<?>")+(2===e?"</svg>":"");return[void 0!==l$2?l$2.createHTML(n):n,s]};class N{constructor({strings:t,_$litType$:e},r){let s;this.parts=[];let o=0,a=0;const i=t.length-1,n=this.parts,[l,h]=M(t,e);if(this.el=N.createElement(l,r),E.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=E.nextNode())&&n.length<i;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(n$5)){const r=h[a++];if(t.push(e),void 0!==r){const t=s.getAttribute(r.toLowerCase()+"$lit$").split(n$5),e=/([.?@])?(.*)/.exec(r);n.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?I:"?"===e[1]?L:"@"===e[1]?R:H})}else n.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(y.test(s.tagName)){const t=s.textContent.split(n$5),e=t.length-1;if(e>0){s.textContent=o$6?o$6.emptyScript:"";for(let r=0;r<e;r++)s.append(t[r],c()),E.nextNode(),n.push({type:2,index:++o});s.append(t[e],c())}}}else if(8===s.nodeType)if(s.data===h$2)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(n$5,t+1));)n.push({type:7,index:o}),t+=n$5.length-1}o++}}static createElement(t,e){const r=u.createElement("template");return r.innerHTML=t,r}}function S$1(t,e,r=t,s){var o,a,i,n;if(e===w)return e;let c=void 0!==s?null===(o=r.Σi)||void 0===o?void 0:o[s]:r.Σo;const l=d(e)?void 0:e._$litDirective$;return(null==c?void 0:c.constructor)!==l&&(null===(a=null==c?void 0:c.O)||void 0===a||a.call(c,!1),void 0===l?c=void 0:(c=new l(t),c.T(t,r,s)),void 0!==s?(null!==(i=(n=r).Σi)&&void 0!==i?i:n.Σi=[])[s]=c:r.Σo=c),void 0!==c&&(e=S$1(t,c.S(t,e.values),c,s)),e}class k{constructor(t,e){this.l=[],this.N=void 0,this.D=t,this.M=e}u(t){var e;const{el:{content:r},parts:s}=this.D,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:u).importNode(r,!0);E.currentNode=o;let a=E.nextNode(),i=0,n=0,c=s[0];for(;void 0!==c;){if(i===c.index){let e;2===c.type?e=new C(a,a.nextSibling,this,t):1===c.type?e=new c.ctor(a,c.name,c.strings,this,t):6===c.type&&(e=new z(a,this,t)),this.l.push(e),c=s[++n]}i!==(null==c?void 0:c.index)&&(a=E.nextNode(),i++)}return o}v(t){let e=0;for(const r of this.l)void 0!==r&&(void 0!==r.strings?(r.I(t,r,e),e+=r.strings.length-2):r.I(t[e])),e++}}class C{constructor(t,e,r,s){this.type=2,this.N=void 0,this.A=t,this.B=e,this.M=r,this.options=s}setConnected(t){var e;null===(e=this.P)||void 0===e||e.call(this,t)}get parentNode(){return this.A.parentNode}get startNode(){return this.A}get endNode(){return this.B}I(t,e=this){t=S$1(this,t,e),d(t)?t===A||null==t||""===t?(this.H!==A&&this.R(),this.H=A):t!==this.H&&t!==w&&this.m(t):void 0!==t._$litType$?this._(t):void 0!==t.nodeType?this.$(t):a$2(t)?this.g(t):this.m(t)}k(t,e=this.B){return this.A.parentNode.insertBefore(t,e)}$(t){this.H!==t&&(this.R(),this.H=this.k(t))}m(t){const e=this.A.nextSibling;null!==e&&3===e.nodeType&&(null===this.B?null===e.nextSibling:e===this.B.previousSibling)?e.data=t:this.$(u.createTextNode(t)),this.H=t}_(t){var e;const{values:r,_$litType$:s}=t,o="number"==typeof s?this.C(t):(void 0===s.el&&(s.el=N.createElement(s.h,this.options)),s);if((null===(e=this.H)||void 0===e?void 0:e.D)===o)this.H.v(r);else{const t=new k(o,this),e=t.u(this.options);t.v(r),this.$(e),this.H=t}}C(t){let e=P.get(t.strings);return void 0===e&&P.set(t.strings,e=new N(t)),e}g(t){v(this.H)||(this.H=[],this.R());const e=this.H;let r,s=0;for(const o of t)s===e.length?e.push(r=new C(this.k(c()),this.k(c()),this,this.options)):r=e[s],r.I(o),s++;s<e.length&&(this.R(r&&r.B.nextSibling,s),e.length=s)}R(t=this.A.nextSibling,e){var r;for(null===(r=this.P)||void 0===r||r.call(this,!1,!0,e);t&&t!==this.B;){const e=t.nextSibling;t.remove(),t=e}}}class H{constructor(t,e,r,s,o){this.type=1,this.H=A,this.N=void 0,this.V=void 0,this.element=t,this.name=e,this.M=s,this.options=o,r.length>2||""!==r[0]||""!==r[1]?(this.H=Array(r.length-1).fill(A),this.strings=r):this.H=A}get tagName(){return this.element.tagName}I(t,e=this,r,s){const o=this.strings;let a=!1;if(void 0===o)t=S$1(this,t,e,0),a=!d(t)||t!==this.H&&t!==w,a&&(this.H=t);else{const s=t;let i,n;for(t=o[0],i=0;i<o.length-1;i++)n=S$1(this,s[r+i],e,i),n===w&&(n=this.H[i]),a||(a=!d(n)||n!==this.H[i]),n===A?t=A:t!==A&&(t+=(null!=n?n:"")+o[i+1]),this.H[i]=n}a&&!s&&this.W(t)}W(t){t===A?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class I extends H{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===A?void 0:t}}class L extends H{constructor(){super(...arguments),this.type=4}W(t){t&&t!==A?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class R extends H{constructor(){super(...arguments),this.type=5}I(t,e=this){var r;if((t=null!==(r=S$1(this,t,e,0))&&void 0!==r?r:A)===w)return;const s=this.H,o=t===A&&s!==A||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,a=t!==A&&(s===A||o);o&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,t),this.H=t}handleEvent(t){var e,r;"function"==typeof this.H?this.H.call(null!==(r=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==r?r:this.element,t):this.H.handleEvent(t)}}class z{constructor(t,e,r){this.element=t,this.type=6,this.N=void 0,this.V=void 0,this.M=e,this.options=r}I(t){S$1(this,t)}}null===(i$4=(t$2=globalThis).litHtmlPlatformSupport)||void 0===i$4||i$4.call(t$2,N,C),(null!==(s$4=(e$3=globalThis).litHtmlVersions)&&void 0!==s$4?s$4:e$3.litHtmlVersions=[]).push("2.0.0-rc.2");
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,e$2=Symbol();class n$4{constructor(t,e){if(e!==e$2)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return t$1&&void 0===this.t&&(this.t=new CSSStyleSheet,this.t.replaceSync(this.cssText)),this.t}toString(){return this.cssText}}const s$3=t=>new n$4(t+"",e$2),o$5=new Map,r$1=(t,...e)=>{const r=e.reduce(((e,r,s)=>e+(t=>{if(t instanceof n$4)return t.cssText;if("number"==typeof t)return t;throw Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(r)+t[s+1]),t[0]);let s=o$5.get(r);return void 0===s&&o$5.set(r,s=new n$4(r,e$2)),s},i$3=(t,e)=>{t$1?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const r=document.createElement("style");r.textContent=e.cssText,t.appendChild(r)}))},S=t$1?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const r of t.cssRules)e+=r.cssText;return s$3(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var s$2,e$1,h$1,r;const o$4={toAttribute(t,e){switch(e){case Boolean:t=t?"":null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let r=t;switch(e){case Boolean:r=null!==t;break;case Number:r=null===t?null:Number(t);break;case Object:case Array:try{r=JSON.parse(t)}catch(t){r=null}}return r}},n$3=(t,e)=>e!==t&&(e==e||t==t),l$1={attribute:!0,type:String,converter:o$4,reflect:!1,hasChanged:n$3};class a$1 extends HTMLElement{constructor(){super(),this.Πi=new Map,this.Πo=void 0,this.Πl=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.Πh=null,this.u()}static addInitializer(t){var e;null!==(e=this.v)&&void 0!==e||(this.v=[]),this.v.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,r)=>{const s=this.Πp(r,e);void 0!==s&&(this.Πm.set(s,r),t.push(s))})),t}static createProperty(t,e=l$1){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const r="symbol"==typeof t?Symbol():"__"+t,s=this.getPropertyDescriptor(t,r,e);void 0!==s&&Object.defineProperty(this.prototype,t,s)}}static getPropertyDescriptor(t,e,r){return{get(){return this[e]},set(s){const o=this[t];this[e]=s,this.requestUpdate(t,o,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||l$1}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this.Πm=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const r of e)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const r=new Set(t.flat(1/0).reverse());for(const t of r)e.unshift(S(t))}else void 0!==t&&e.push(S(t));return e}static"Πp"(t,e){const r=e.attribute;return!1===r?void 0:"string"==typeof r?r:"string"==typeof t?t.toLowerCase():void 0}u(){var t;this.Πg=new Promise((t=>this.enableUpdating=t)),this.L=new Map,this.Π_(),this.requestUpdate(),null===(t=this.constructor.v)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,r;(null!==(e=this.ΠU)&&void 0!==e?e:this.ΠU=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(r=t.hostConnected)||void 0===r||r.call(t))}removeController(t){var e;null===(e=this.ΠU)||void 0===e||e.splice(this.ΠU.indexOf(t)>>>0,1)}"Π_"(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this.Πi.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return i$3(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this.ΠU)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)})),this.Πl&&(this.Πl(),this.Πo=this.Πl=void 0)}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this.ΠU)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)})),this.Πo=new Promise((t=>this.Πl=t))}attributeChangedCallback(t,e,r){this.K(t,r)}"Πj"(t,e,r=l$1){var s,o;const a=this.constructor.Πp(t,r);if(void 0!==a&&!0===r.reflect){const i=(null!==(o=null===(s=r.converter)||void 0===s?void 0:s.toAttribute)&&void 0!==o?o:o$4.toAttribute)(e,r.type);this.Πh=t,null==i?this.removeAttribute(a):this.setAttribute(a,i),this.Πh=null}}K(t,e){var r,s,o;const a=this.constructor,i=a.Πm.get(t);if(void 0!==i&&this.Πh!==i){const t=a.getPropertyOptions(i),n=t.converter,c=null!==(o=null!==(s=null===(r=n)||void 0===r?void 0:r.fromAttribute)&&void 0!==s?s:"function"==typeof n?n:null)&&void 0!==o?o:o$4.fromAttribute;this.Πh=i,this[i]=c(e,t.type),this.Πh=null}}requestUpdate(t,e,r){let s=!0;void 0!==t&&(((r=r||this.constructor.getPropertyOptions(t)).hasChanged||n$3)(this[t],e)?(this.L.has(t)||this.L.set(t,e),!0===r.reflect&&this.Πh!==t&&(void 0===this.Πk&&(this.Πk=new Map),this.Πk.set(t,r))):s=!1),!this.isUpdatePending&&s&&(this.Πg=this.Πq())}async"Πq"(){this.isUpdatePending=!0;try{for(await this.Πg;this.Πo;)await this.Πo}catch(t){Promise.reject(t)}const t=this.performUpdate();return null!=t&&await t,!this.isUpdatePending}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this.Πi&&(this.Πi.forEach(((t,e)=>this[e]=t)),this.Πi=void 0);let e=!1;const r=this.L;try{e=this.shouldUpdate(r),e?(this.willUpdate(r),null===(t=this.ΠU)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(r)):this.Π$()}catch(t){throw e=!1,this.Π$(),t}e&&this.E(r)}willUpdate(t){}E(t){var e;null===(e=this.ΠU)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}"Π$"(){this.L=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.Πg}shouldUpdate(t){return!0}update(t){void 0!==this.Πk&&(this.Πk.forEach(((t,e)=>this.Πj(e,this[e],t))),this.Πk=void 0),this.Π$()}updated(t){}firstUpdated(t){}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n$1=t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:r,elements:s}=e;return{kind:r,elements:s,finisher(e){window.customElements.define(t,e)}}})(t,e)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}const o$2=({finisher:t,descriptor:e})=>(r,s)=>{var o;if(void 0===s){const s=null!==(o=r.originalKey)&&void 0!==o?o:r.key,a=null!=e?{kind:"method",placement:"prototype",key:s,descriptor:e(r.key)}:{...r,key:s};return null!=t&&(a.finisher=function(e){t(e,s)}),a}{const o=r.constructor;void 0!==e&&Object.defineProperty(r,s,e(s)),null==t||t(o,s)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;function o$1(t,e){return o$2({descriptor:r=>{const s={get(){var e;return null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t)},enumerable:!0,configurable:!0};if(e){const e="symbol"==typeof r?Symbol():"__"+r;s.get=function(){var r;return void 0===this[e]&&(this[e]=null===(r=this.renderRoot)||void 0===r?void 0:r.querySelector(t)),this[e]}}return s}})}function assertNever(t,e=""){throw new Error(e||"Unexpected object: "+t)}function createOverlayDiv(){const t=document.createElement("div");return t.style.left="0",t.style.top="0",t.style.bottom="0",t.style.right="0",t.style.position="absolute",t.style.backgroundColor="transparent",t.style.cursor="grab",t}function isMobile(t=896){return!window.matchMedia(`(min-width:  ${t+1}px)`).matches}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var __decorate$7=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcAppDrawer=class extends h{constructor(t){super(),this.selectedDrawer="",this.drawerOpen=!1,this.drawers=[{name:"foto-preview",title:"Fotos",icon:"camera-retro-duotone"},{name:"map",title:"Karte",icon:"map-duotone"},{name:"trip-details",title:"Reisedaten",icon:"plane-duotone"}],this.selectedDrawer=t}static get styles(){return[drawerStyles]}connectedCallback(){super.connectedCallback()}getDrawerSelection(t){this.callback=t}openDrawer(){this.drawerOpen=!this.drawerOpen,this.requestUpdate()}setDrawerSelection(t){this.selectedDrawer=t,this.callback&&this.callback(this.selectedDrawer)}render(){return T`
    ...
    `}};__decorate$7([e({type:String})],WcAppDrawer.prototype,"selectedDrawer",void 0),WcAppDrawer=__decorate$7([n$1("wc-app-drawer")],WcAppDrawer);const uploadStyles=r$1`
  .upload-page {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;class NobsBase{constructor(t,e){if(t instanceof Nobs&&e instanceof NobsBase){t._called_from_constructor_findMutations(e);for(const r of Object.keys(e)){const s=e[r];s instanceof NobsBase?t.hasObjectReplacement(s)?this[r]=t.getObjectReplacement(s):t._called_from_constructor_hasMutation(s)?this[r]=new s.constructor(t,s):this[r]=s:s instanceof Map?this[r]=t._called_from_constructor_cloneMap(s):Array.isArray(s)?this[r]=t._called_from_constructor_cloneArray(s):t.hasProperty(e,r)?this[r]=t.popProperty(e,r):this[r]=e[r]}const r=t.getChangedProperties(e);if(r&&r.size>0)for(const[t,e]of r)this[t]=e}}}class Nobs{constructor(){this.createdObjects=new Map,this.replacedObjects=new Map,this.removedObjects=new Set,this.changedProperties=new Map,this.replacedCollections=new Map,this.mutatedObjects=new Set}setProperty(t,e,r){if(t&&(r instanceof NobsBase||null===r)&&t[e]instanceof NobsBase)this.replaceObject(t[e],r);else{let s=this.changedProperties.get(t);s||(s=new Map,this.changedProperties.set(t,s)),s.set(e,r)}return this}getChangedProperties(t){return this.changedProperties.get(t)}getProperty(t,e){const r=this.changedProperties.get(t);return r&&r.has(e)?r.get(e):t[e]}popProperty(t,e){const r=this.changedProperties.get(t);if(r&&r.has(e)){const t=r.get(e);return r.delete(e),t}return t[e]}hasProperty(t,e){const r=this.changedProperties.get(t);return!(!r||!r.has(e))}replaceCollection(t,e){return this.replacedCollections.set(t,e),this}addToCollection(t,e,r,s){let o=this.createdObjects.get(t);o||(o=[],this.createdObjects.set(t,o));const a={object:e,insertBefore:r,insertAfter:s};return o.push(a),this}reOrderInsideCollection(t,e,r,s){return e!==r&&e!==s&&(this.removeObject(e),this.addToCollection(t,e,r,s)),this}replaceObject(t,e){return this.replacedObjects.set(t,e),this}hasObjectReplacement(t){return this.replacedObjects.has(t)}getObjectReplacement(t){return this.replacedObjects.get(t)}removeObject(t){return this.removedObjects.add(t),this}_called_from_constructor_hasMutation(t){return this.mutatedObjects.has(t)}_called_from_constructor_findMutations(t){let e=!1;for(const r of Object.keys(t)){const s=t[r];if(this.hasProperty(t,r)&&(e=!0),s instanceof NobsBase)(this.replacedObjects.has(s)||this._called_from_constructor_findMutations(s))&&(this.mutatedObjects.add(s),e=!0);else if(s instanceof Map||Array.isArray(s)){if(this.replacedCollections.has(s)&&(this.mutatedObjects.add(s),e=!0),s instanceof Map)for(const t of s.values())(this.removedObjects.has(t)||this.replacedObjects.has(t))&&(this.mutatedObjects.add(t),e=!0),e=this._called_from_constructor_findMutations(t)||e;else for(const t of s)(this.removedObjects.has(t)||this.replacedObjects.has(t))&&(this.mutatedObjects.add(t),e=!0),e=this._called_from_constructor_findMutations(t)||e;this.createdObjects.has(s)&&(e=!0)}}return e&&this.mutatedObjects.add(t),e}static getId(t){const e=t.id;if(!e)throw new Error("Nobs: By convention, objects stored in a Map need to have an 'id' property");return e}_called_from_constructor_cloneMap(t){const e=new Map,r=this.replacedCollections.get(t);if(r&&r instanceof Map)return r;let s;const o=this.createdObjects.get(t);for(const[r,a]of t.entries())if(!this.removedObjects.has(a)){if(s=this.replacedObjects.get(a),!s&&this.mutatedObjects.has(a)&&(s=new a.constructor(this,a)),s||(s=a),o)for(const t of o)t.insertBefore===s&&e.set(Nobs.getId(t.object),t.object);if(e.set(r,s),o)for(const t of o)t.insertAfter===s&&e.set(Nobs.getId(t.object),t.object)}if(o)for(const t of o)void 0===t.insertBefore&&void 0===t.insertAfter&&e.set(Nobs.getId(t.object),t.object);return e}_called_from_constructor_cloneArray(t){const e=[],r=this.replacedCollections.get(t);if(r&&Array.isArray(r))return r;let s;const o=this.createdObjects.get(t);for(const r of t)if(!this.removedObjects.has(r)){if(s=this.replacedObjects.get(r),!s&&this.mutatedObjects.has(r)&&(s=new r.constructor(this,r)),s||(s=r),o)for(const t of o)t.insertBefore===s&&e.push(t.object);if(e.push(s),o)for(const t of o)t.insertAfter===s&&e.push(t.object)}if(o)for(const t of o)void 0===t.insertBefore&&void 0===t.insertAfter&&e.push(t.object);return e}}class UploadNobs extends NobsBase{constructor(t,e){var r,s,o,a,i;if(super(t,e),!(t instanceof Nobs||e instanceof UploadNobs)){const e=t;this.id="",this.headline=null!==(r=e.headline)&&void 0!==r?r:"",this.story=null!==(s=e.story)&&void 0!==s?s:"",this.date=null!==(o=e.date)&&void 0!==o?o:new Date,this.location=null!==(a=e.location)&&void 0!==a?a:[],this.foldername=null!==(i=e.foldername)&&void 0!==i?i:""}}toDto(){return{id:"",headline:this.headline,story:this.story,date:this.date,location:this.location,foldername:this.foldername}}}const fotoUploadStyles=r$1`
...
`;var __decorate$6=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};const fileTypes=["image/jpg","image/bmp","image/jpeg","image/png","image/tiff","image/webp"],validFileType=t=>fileTypes.includes(t.type);let WcUploadFotos=class extends h{constructor(t,e){super(),this.foldername=t,this.date=e}static get styles(){return[fotoUploadStyles]}updateImageDisplay(t){console.log(t.target.files);const e=t.target.files;if(e){for(const t of e)if(validFileType(t)){const e=document.createElement("img"),r=this.date+"_"+this.foldername;e.src=URL.createObjectURL(t),e.alt=t.name,uploadImage(t,r)}alert("files uploaded")}}render(){return T`
    ...
    `}};__decorate$6([e({type:String})],WcUploadFotos.prototype,"foldername",void 0),__decorate$6([e({type:String})],WcUploadFotos.prototype,"date",void 0),__decorate$6([o$1(".preview")],WcUploadFotos.prototype,"preview",void 0),__decorate$6([o$1(".file-input")],WcUploadFotos.prototype,"fileInput",void 0),WcUploadFotos=__decorate$6([n$1("wc-upload-fotos")],WcUploadFotos);const formStyles=r$1`
  form {
    font-family: Ubuntu, 'Open Sans', 'Helvetica Neue', sans-serif;
    display: flex;
    flex-direction: column;
...
`;var __decorate$5=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i},__awaiter$2=function(t,e,r,s){return new(r||(r=Promise))((function(o,a){function i(t){try{c(s.next(t))}catch(t){a(t)}}function n(t){try{c(s.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?o(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((s=s.apply(t,e||[])).next())}))};let WcUploadForm=class extends h{constructor(){super(...arguments),this.images=[]}static get styles(){return[formStyles]}setState(t){this.state=new UploadNobs(t,this.state)}connectedCallback(){super.connectedCallback();const t=new Nobs;t.setProperty(this.state,"id",""),this.setState(t)}getPics(t){let e=[];firebase.storage().ref(t).listAll().then((function(t){t.items.forEach((t=>{t.getDownloadURL().then((t=>{e=[...e,t],console.log(e)}))}))})).catch((function(t){console.log(t)})),setTimeout((()=>this.images=e),2e3)}handleSubmit(t){return __awaiter$2(this,void 0,void 0,(function*(){t.preventDefault();const e=this.state.date+"_"+this.state.foldername;try{yield this.getPics(e),setTimeout((()=>createTravelDocument(this.state,this.images)),3e3)}catch(t){console.log(t)}}))}handleChange(t){const e=new Nobs,r=t.target.name,s=t.target.value;e.setProperty(this.state,r,s),this.setState(e)}handleLocation(t){const e=new Nobs,r=t.target.name,s=t.target.value.split(",");e.setProperty(this.state,r,s),this.setState(e)}renderFileLoader(){const t=this.state?this.state.foldername:"",e=this.state?this.state.date:"";return new WcUploadFotos(t,e)}render(){return T`
    ...
    `}};__decorate$5([e({type:Object})],WcUploadForm.prototype,"state",void 0),__decorate$5([e({type:Object})],WcUploadForm.prototype,"images",void 0),WcUploadForm=__decorate$5([n$1("wc-upload-form")],WcUploadForm);var __decorate$4=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcUploadPage=class extends h{static get styles(){return[uploadStyles]}render(){return T`
      <div class="upload-page">
        <h1 class="title">Upload Foto Story</h1>
        <wc-upload-form></wc-upload-form>
      </div>
    `}};WcUploadPage=__decorate$4([n$1("wc-upload-page")],WcUploadPage);const fotostoryStyles=r$1`
  .fotostory-container {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var __decorate$3=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcFotostory=class extends h{constructor(t){super(),this.fotostory=t}static get styles(){return[fotostoryStyles]}render(){var t;return T`
    ${this.fotostory?T`
    ...
    `}};__decorate$3([e({type:Object})],WcFotostory.prototype,"fotostory",void 0),WcFotostory=__decorate$3([n$1("wc-fotostory")],WcFotostory);const fotoPreviewStyles=r$1`
  .welcome-page {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var __decorate$2=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i},__awaiter$1=function(t,e,r,s){return new(r||(r=Promise))((function(o,a){function i(t){try{c(s.next(t))}catch(t){a(t)}}function n(t){try{c(s.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?o(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((s=s.apply(t,e||[])).next())}))};let WcFotoPreview=class extends h{constructor(){super(...arguments),this.date=new Date,this.month="Juni",this.showStory=!1}static get styles(){return[fotoPreviewStyles]}connectedCallback(){super.connectedCallback(),this.loadFotos()}loadFotos(){return __awaiter$1(this,void 0,void 0,(function*(){const t=[];try{yield firestore.collection("fuerte").get().then((t=>t.docs.map((t=>t.data())))).then((e=>{e.forEach((e=>t.push(e)))})).catch((t=>console.log("no traveldocs found",t)))}catch(t){console.log(t)}this.fotos=t,console.log(this.fotos)}))}renderFotostory(){return new WcFotostory(this.fotostory)}renderFotos(t,e){const r=this.fotos.filter((r=>new Date(r.date).getDate()===t&&new Date(r.date).getMonth()+1===e));this.fotostory=r[0],this.showStory=!0}renderJuneCalendar(){const t=[];for(let e=1;e<=30;e++)t.push(e);return T`
    ...
    `}};__decorate$2([e({type:Array})],WcFotoPreview.prototype,"fotos",void 0),__decorate$2([e({type:Object})],WcFotoPreview.prototype,"fotostory",void 0),__decorate$2([e({type:Object})],WcFotoPreview.prototype,"date",void 0),__decorate$2([e({type:String})],WcFotoPreview.prototype,"month",void 0),__decorate$2([e({type:Boolean})],WcFotoPreview.prototype,"showStory",void 0),WcFotoPreview=__decorate$2([n$1("wc-foto-preview")],WcFotoPreview);const traveldetailsStyles=r$1`
...
`;var __decorate$1=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcTraveldetailsPage=class extends h{static get styles(){return[traveldetailsStyles]}render(){return T`
    ...
    `}};WcTraveldetailsPage=__decorate$1([n$1("wc-traveldetails-page")],WcTraveldetailsPage);var __decorate=function(t,e,r,s){var o,a=arguments.length,i=a<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,r,s);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(i=(a<3?o(i):a>3?o(e,r,i):o(e,r))||i);return a>3&&i&&Object.defineProperty(e,r,i),i};let WcAppLayout=class extends h{constructor(){super(...arguments),this.selectedDrawer="foto-preview"}static get styles(){return[layoutStyles,navbarStyles]}render(){return T`
        ...
        `}renderDrawer(){const t=new WcAppDrawer(this.selectedDrawer);return t.getDrawerSelection((t=>{this.selectedDrawer=t})),t}getUserContent(){switch(this.selectedDrawer){case"trip-details":return new WcTraveldetailsPage;case"foto-preview":return new WcFotoPreview;case"upload":return new WcUploadPage}}userClick(t){showCtxMenu(t,[{caption:"Log out",callback:()=>{this.logoutUser()}}])}logoutUser(){logoutFunc()}};__decorate([e({type:String})],WcAppLayout.prototype,"selectedDrawer",void 0),WcAppLayout=__decorate([n$1("wc-app-layout")],WcAppLayout),r$1`
  :host, :host * {
    box-sizing: border-box; 
  }
  :host  {
...
`;var _a,_b,_c,__awaiter=function(t,e,r,s){return new(r||(r=Promise))((function(o,a){function i(t){try{c(s.next(t))}catch(t){a(t)}}function n(t){try{c(s.throw(t))}catch(t){a(t)}}function c(t){var e;t.done?o(t.value):(e=t.value,e instanceof r?e:new r((function(t){t(e)}))).then(i,n)}c((s=s.apply(t,e||[])).next())}))};const wcAppLayout=new WcAppLayout;let appUser="user";function setDisplay(t,e){const r=document.getElementById(t);r&&(r.style.display=e)}null===(_a=document.getElementById("createAccountCtrl"))||void 0===_a||_a.addEventListener("click",(()=>__awaiter(void 0,void 0,void 0,(function*(){var t,e;const r=null===(t=document.getElementById("emailCtrl"))||void 0===t?void 0:t.value,s=null===(e=document.getElementById("passwordCtrl"))||void 0===e?void 0:e.value;yield signinUser(r,s)})))),null===(_b=document.getElementById("google-signin"))||void 0===_b||_b.addEventListener("click",(()=>__awaiter(void 0,void 0,void 0,(function*(){yield signinWithGoogle()})))),firebase.auth().onAuthStateChanged((function(t){return __awaiter(this,void 0,void 0,(function*(){if(t){appUser="trulli90@gmail.com"===t.email?"admin":"user",setDisplay("userAccount",""),setDisplay("loginPage","none");const e=document.getElementById("userAccount");null==e||e.append(wcAppLayout);const r=document.getElementsByTagName("head")[0],s=document.createElement("style");s.setAttribute("type","text/css"),s.appendChild(document.createTextNode(masterStyles.toString())),r.appendChild(s)}else setDisplay("loginPage","")}))}));const logoutFunc=()=>{__awaiter(void 0,void 0,void 0,(function*(){yield firebase.auth().signOut(),window.location.reload()}))};null===(_c=document.getElementById("eye"))||void 0===_c||_c.addEventListener("click",(()=>{const t=document.getElementById("eye"),e=document.getElementById("passwordCtrl");"password"===e.type?(t.classList.remove("fa-eye-slash"),t.classList.add("fa-eye"),e.type="text"):(t.classList.remove("fa-eye"),t.classList.add("fa-eye-slash"),e.type="password")}));export{appUser,logoutFunc};