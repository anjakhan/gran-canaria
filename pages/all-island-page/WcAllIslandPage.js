      ...
      ${this.showDetails ? this.renderSightseeingPage() : html `
        <div class="all-island-page">
          ...
          <div class="filter-container">
            ...
            <select name="topic" id="topic" @change=${(e) => this.filterSightseeings(e)}>
            ...
            <select name="orientation" id="orientation" @change=${(e) => this.filterSightseeings(e)}>
              <option value="All Island">Ganze Insel</option>
